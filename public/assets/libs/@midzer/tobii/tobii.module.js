...
function n(a) {
  const s = { image: new e(), html: new i(), iframe: new t(), youtube: new r() },
    o = [
  ...
  let d = {}
  const l = [],
    u = { gallery: [], slider: null, sliderElements: [], elementsLength: 0, currentIndex: 0, x: 0 }
  let c = null,
    b = null,
    p = null,
    h = null,
  ...
  const C = (e) => {
    ...
    P = (e) => {
      if (
        ((I = T(e)),
        Object.prototype.hasOwnProperty.call(_, I) || ((_[I] = JSON.parse(JSON.stringify(u))), Y()),
    ...
    G = (e) => {
      e.target === b
        ...
        ? R()
        : (e.target === h ||
            (!1 === y && !1 === v && e.target.classList.contains('tobii__slide') && d.docClose)) &&
          U(),
        e.stopPropagation()
    },
    J = (e) => {
    ...
    ne = () => {
      Math.abs(g.startX - g.endX) > 0 && !v && _[S].elementsLength > 1
