          ...
          ;(n.style.opacity = '0'),
            ...
            this.userSettings.captions &&
              ('function' == typeof this.userSettings.captionText
                ...
                ? (r.textContent = e.getAttribute(this.userSettings.captionAttribute))
                : 'img' === this.userSettings.captionsSelector &&
                  a &&
                  a.getAttribute(this.userSettings.captionAttribute) &&
                  (r.textContent = a.getAttribute(this.userSettings.captionAttribute)),
              r.textContent &&
    ...
    r = /*#__PURE__*/ (function () {
      ...
      return (
        ...
        (t.onLeave = function (e) {
          var t = e.querySelector('video')
          t &&
            (t.paused || t.pause(), t.readyState > 0 && t.setAttribute('data-time', t.currentTime))
        }),
        (t.onCleanup = function (e) {
          var t = e.querySelector('video')
    ...
    var s = { image: new i(), html: new r(), iframe: new n(), youtube: new o() },
      ...
      j = function () {
        ;(I[(C = null !== C ? C : S)].slider.style.transform =
          'translate3d(' + (E = -I[C].currentIndex * p.offsetWidth) + 'px, 0, 0)'),
          (L = E)
      },
      W = function () {
      ...
      Q = function (e) {
        ...
        9 === e.keyCode || 'Tab' === e.code
          ...
          ? (e.preventDefault(), M())
          : (39 !== e.keyCode && 'ArrowRight' !== e.code) || (e.preventDefault(), H())
      },
      Z = function (e) {
        be(e.target) ||
          (e.stopPropagation(),
      ...
      $ = function (e) {
        e.stopPropagation(),
          w && ((g.endX = e.touches[0].pageX), (g.endY = e.touches[0].pageY), oe())
      },
      ee = function (e) {
        e.stopPropagation(),
          (w = !1),
      ...
      oe = function () {
        Math.abs(g.startX - g.endX) > 0 && !y && I[C].elementsLength > 1
          ? ((I[C].slider.style.transform =
              'translate3d(' + (L - Math.round(g.startX - g.endX)) + 'px, 0, 0)'),
            (v = !0),
            (y = !1))
          : Math.abs(g.startY - g.endY) > 0 &&
            ...
            l.swipeClose &&
            ((I[C].slider.style.transform =
              'translate3d(' + L + 'px, -' + Math.round(g.startY - g.endY) + 'px, 0)'),
            (v = !1),
            (y = !0))
      },
      ae = function () {
      ...
      le = function (e) {
        j(),
          ...
          (function (e) {
            ;(!0 === l.nav || 'auto' === l.nav) && !pe() && I[C].elementsLength > 1
              ? (b.setAttribute('aria-hidden', 'true'),
                (b.disabled = !0),
                h.setAttribute('aria-hidden', 'true'),
                (h.disabled = !0),
      ...
      (function (e) {
        if (document.querySelector('div.tobii'))
          ...
          ;(l = (function (e) {
            ...
            p ||
              ((p = document.createElement('div')).setAttribute('role', 'dialog'),
              p.setAttribute('aria-hidden', 'true'),
